...
describe('Logo is rendering', () => {
    test('Logo made with Triangle', () => {
        ...
        // assertions based on rendering requirements Triangle logo
    ...
    test('Logo made with Circle', () => {
        ...
        // assertions based on rendering requirements Circle logo
        expect(result).toContain('<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">');
    ...
    test('Logo made with Square', () => {
        ...
        // assertions based on rendering requirements Square logo
        expect(result).toContain('<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">');
